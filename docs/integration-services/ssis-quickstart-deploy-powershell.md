...
## SSIS PowerShell Provider option
Provide appropriate values for the variables at the top of the following script, and then run the script to deploy the SSIS project using the SSIS PowerShell Provider.
